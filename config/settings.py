"""
Django settings for PCOD GirlCare project.
"""
import os
...
# Load .env from project root (for RESEND_API_KEY, etc.)
try:
...
if RESEND_API_KEY:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'PCOD GirlCare <onboarding@resend.dev>')
else:
